...
popup_rapca_gr <- paste0(
  "<strong>Unidad:</strong> ", rapca_gr$UNIDAD,
  "<br><strong>Código Unidad:</strong> ", rapca_gr$ID_UNIDAD,
  "<br><strong>Longitud:</strong> ", paste0(round(rapca_gr$LONG_UNID,0), " m"),
  "<br><strong>Anchura:</strong> ", paste0(round(rapca_gr$ANCHO_UNID,0), " m"),
  "<br><strong>Superficie</strong> ", paste0(round(rapca_gr$SUPERFIC_1,2), " ha"),
  "<br><strong>Zona:</strong> ", paste0(rapca_gr$ZONA, " (", rapca_gr$ID_ZONA, ")")
)
